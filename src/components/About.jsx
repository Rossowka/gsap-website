		...
		<div id='about'>
			...
			<div className='top-grid'>
				...
				<div className='md:col-span-6'>
					...
					<img
						src='/images/abt2.png'
						alt='happy people holding up their drinks'
					/>
				</div>
				...
				<div className='md:col-span-3'>
					...
					<img
						src='/images/abt5.png'
						alt='a close up of bartender straining a cocktail'
					/>
				</div>
			</div>
			...
			<div className='bottom-grid'>
				<div className='md:col-span-8'>
					...
					<img
						src='/images/abt3.png'
						alt='colorful cocktails standing in a row'
					/>
				</div>
				<div className='md:col-span-4'>
					...
					<img
						src='/images/abt4.png'
						alt='cocktail surrounded by fruits and flowers'
					/>
				</div>
			</div>
		</div>
